...
from utils import RigidTransform, axisangle2mat, mat_update_resolution
...
from utils import Volume, Stack
...
class SliceToVolumeRegistration(Registration):
    ...
    def update_level(
        ...
        self.slices_mask_resampled = (
            (
                resample(self.slices_mask.float(), [1] * 2, [2**self.current_level] * 2)
                > 0
            )
    ...
    def forward(
        ...
        assert abs(stack.resolution_x - stack.resolution_y) < eps, (
